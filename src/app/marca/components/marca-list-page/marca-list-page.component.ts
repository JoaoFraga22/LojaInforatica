...
export class MarcaListPageComponent implements ViewWillEnter, ViewDidLeave, OnDestroy {
  ...
  async lista() {
    ...
    const subscription = this.marcaService.getMarcas()
      .subscribe(async (marcas) => {
        this.marcas = marcas;
      ...
      buttons: [
        {
          ...
          handler: () => {
            this.subscriptions.add(
              this.marcaService.remove(marca).subscribe(() => this.lista())
            );
          },
        },
        'Não',
